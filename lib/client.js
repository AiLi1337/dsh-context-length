	...
	factory: (require) => {
		...
		if (typeof document !== "undefined" && document.querySelector("style[data-plugin-css=\"" + CSS_ID + "\"]") === null) {
			...
			tag.textContent = [
				...
				".dcl-level-tag{font-size:11px;padding:1px 7px;border-radius:6px;background:var(--dsw-alias-interactive-bg-hover-solid);color:var(--dsw-alias-label-secondary);font-family:var(--ds-font-family-code,monospace)}",
				...
				".dcl-effort-caret{color:var(--dsw-alias-label-tertiary);font-size:11px;flex-shrink:0}",
				".dcl-effort-pop{position:absolute;top:calc(100% + 4px);left:0;right:0;z-index:30;background:var(--dsw-alias-bg-module-platform);border:1px solid var(--dsw-alias-border-l2);border-radius:10px;box-shadow:var(--dsw-shadow-lv2,0 8px 24px rgba(0,0,0,.16));padding:6px;display:flex;flex-direction:column;max-height:280px;overflow-y:auto}",
				".dcl-effort-option{display:flex;align-items:center;gap:8px;padding:7px 8px;border-radius:7px;cursor:pointer;font-size:13px;line-height:18px;color:var(--dsw-alias-label-primary)}",
				".dcl-effort-option:hover{background:var(--dsw-alias-interactive-bg-hover-solid)}",
				...
				".dcl-effort-backdrop{position:fixed;inset:0;z-index:20;background:transparent}",
									...
									effortSupport === "ok" && reasoningState.kind !== "disabled" ? react_jsx_runtime.jsxs("div", {
										...
										children: [
											react_jsx_runtime.jsx("button", {
												type: "button",
												className: "dcl-input dcl-effort-trigger",
												...
												children: [
													...
													react_jsx_runtime.jsx("span", { className: "dcl-effort-caret", children: "\u25BE" })
												]
											}),
