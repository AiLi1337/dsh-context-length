	...
	factory: (require) => {
		...
		if (typeof document !== "undefined" && document.querySelector("style[data-plugin-css=\"" + CSS_ID + "\"]") === null) {
			...
			tag.textContent = [
				...
				".dcl-preset-tag.is-active{background:rgba(59,130,246,.12);color:var(--dsw-alias-brand-primary);border-color:rgba(59,130,246,.3)}",
										...
										children: [
											EFFORT_LEVELS.map((level) => {
												...
												return react_jsx_runtime.jsx("button", {
													type: "button",
													className: active ? "dcl-preset-tag is-active" : "dcl-preset-tag",
